        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap text-black">Capture your favorite memories with your own <span className="font-semibold">one-on-one</span> phone case. CaseCobra allows you to protect your memories, not just your phone case.
              </p>
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                <div className="flex flex-col items-center sm:items-start justify-between">
                  <div className="flex gap-0.5">
                    <StarIcon className="h-4 w-4 text-green-600 fill-green-500" />
                    <StarIcon className="h-4 w-4 text-green-600 fill-green-500" />
                    <StarIcon className="h-4 w-4 text-green-600 fill-green-500" />
                    <StarIcon className="h-4 w-4 text-green-600 fill-green-500" />
                    <StarIcon className="h-4 w-4 text-green-600 fill-green-500" />
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto max-w-2xl grid  grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p className="text-black">
                  ...
                  {` `}, on the case I had before the image started fading  into yellow-ish color after couple weeks. Love it"
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p className="text-black">
                  "I usually keep my phone together with my keys in my pocket and the led to some pretty heavy scratchmarks on all my last phone cases. This one, besides a barely noticeable scratch on the corner{` `}
                  <span className="p-0.5 bg-slate-800 text-white">
                    looks brand new after about hald a year
                  </span>
                  {` `}.I dig it."
                </p>
              </div>
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              />
              <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xlk">
                <img
                  src="/horse.jpg"
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit text-black">
            <li className="w-fit">
            ...
            <div className=" flex justify-center">
              <Link href='/configure/upload' className={buttonVariants({
                ...
                Create Your Case Now <ArrowRightIcon className="h-5 w-5 ml-1.5"/>
              </Link>
            </div>
          </ul>
        </MaxWidthWrapper>
