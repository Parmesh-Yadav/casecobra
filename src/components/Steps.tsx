                ...
                STEPS.map((step, index) => {
                    ...
                    return (
                        <li key={step.name} className="relative overflow-hidden lg:flex-1">
                            <div>
                                <span
                                    className={cn("absolute left-0 top-0 h-full w-1 bg-zinc-400 lg:bottom-0 lg:top-auto lg:w-full lg:h-1", {
                                ...
                                <span className={cn(index !== 0 ? 'lg:pl-9' : "", "flex items-center px-6 py-4 text-sm font-medium")}>
                                    ...
                                    <span className="ml-4 mt-0.5  h-full flex  min-w-0 flex-col justify-center">
